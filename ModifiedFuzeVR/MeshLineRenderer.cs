//Modified by Oliver Lykken from FusedVR
...
public class MeshLineRenderer : MonoBehaviour
{
    ...
    //checks if this is the first point being drawn
    ...
    //Continously puts new points onto the line
    public void AddPoint(Vector3 point)
    {
        if (s != Vector3.zero)
        {
            AddLine(lineMesh, MakeQuad(s, point, startSize, firstQuad));
            firstQuad = false;
        }
    ...
    //Makes the actual quads: e is the end point, w is the width, all checks if this is the first quad being drawn
    Vector3[] MakeQuad(Vector3 s, Vector3 e, float w, bool all)
    {
        ...
        //Line rotation is not based on rotation of controller
        //Vector3 n = Vector3.Cross(s, e);
        //Vector3 l = Vector3.Cross(n, e - s);
        
        //Line rotation based on rotation of controller
    ...
    //Continously builds the line as drawn using the generated quads
